---
layout: post
title: "The Tape Answers Back: A Hollow Advance"
date: 2026-06-17
...
image: /assets/posts/2026-06-17-hollow-advance/cards/dow.png
image_alt: "The E-mini Dow rides a steep rising line to a new high while its calendar spread deepens into contango — a hollow advance the tape has not confirmed."
...
but *lean* was the word, not lunge, and the whole of that lean rested on one condition I named out
loud: the Dollar Index had to *reject* the 100 handle and roll off its rising support, sterling
...
That is where a careful reader stops and turns the lamp up. A market that advances without the
...
with its own term structure. Three divergences, all pointing the same way. The climb is hollow.
...
very nearly alone in doing so.

The crowd reads that new high in the Dow as strength. I read it as narrowing. When the broad index
and the growth index both make lower highs while the heaviest, slowest name carries the tape up by
itself, the advance is not being confirmed — it is being *carried*, on fewer and fewer shoulders.
...
have split. The 30-year T-Bond, near 93.8, has stopped falling and *turned up*, climbing a rising
...
while the front and the belly are sold.

Now, the long bond is the market's truest instrument of fear — the thing money runs to when it
begins to doubt the future and to want duration and safety in its hands. For that instrument to be
quietly accumulated *while stocks make new highs* is two markets telling two different stories at
...
direction. The bond board has begun to whisper risk-*off* while the stock board still shouts
risk-on — and I have learned to trust the whisper.
...
A rising price with a deepening contango is a market making new highs while the men who must
actually carry the position grow *less* willing to pay up for the here-and-now and *more* content to
...
the market will not sign — and an unsigned advance is, as often as not, a fake one.

---

## The read — sell the break, not the high

Put the three together and the verdict is harder than last week's, because the condition I set last
...
is the public's, the late selling is the smart hand's, and the new high is the bait on the hook.

But understand the discipline, because the discipline is the whole of the edge. A divergence is a
*warning*, not a *signal*. I do not short a market merely because it has diverged — to sell a strong
...
reasons can be. So I will not short the high. I will short the *break* — and I will let the tape
...
lower highs they have started; and above all the dollar, whose *failure* to break is the cap holding
firm, so that the day the leaders give way the wind itself reverses. Let the rising lines give. Let
the Dow lose the trend it is riding and the others lose their floors. *Then* the divergence becomes a
trend, the warning becomes a position, and the line of least resistance points down — and I will
sit on the short side with the wind at my back the same way I sat on the long.

Until that hour, the position to hold is cash, and cash is a position — frequently the strongest one
...
marked, waiting for the tape to stop confessing and start *confirming* — and the way every part of
this board is leaning, I do not think the wait will be a long one.
